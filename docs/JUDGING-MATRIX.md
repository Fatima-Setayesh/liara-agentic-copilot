...
| UI/UX — core chat experience | 20 | Accessible conversation surface using shadcn/ui and AI Elements conventions | Working message input, streamed response, code rendering, loading, retry, and empty/error states | Planned | Frontend |
